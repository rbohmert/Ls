...
/*   Updated: 2016/02/18 23:52:34 by rbohmert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		cmp(t_list *lg, t_list *ld, int flag)
{
	...
	if (flag == 2)
		return ((ft_strcmp(((t_file *)lg->content)->name, ((t_file *)ld->content)->name) <= 0) ? 1 : 0);
	if (flag == 3)
		return((((t_file *)lg->content)->stat->st_mtime >= ((t_file *)ld->content)->stat->st_mtime) ? 1 : 0);
	return (0);
}
